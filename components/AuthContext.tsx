    ...
    switch (role) {
      case UserRole.ADMIN:
        return [
          ...
          'WS_VIEW', 'WS_MANAGE', 'ROUTING_VIEW', 'ROUTING_MANAGE', 'WO_VIEW', 'WO_MANAGE', 'WO_SCHEDULE',
          'INSP_VIEW', 'INSP_EXECUTE', 'SPC_VIEW',
          'INV_VIEW', 'INV_MANAGE', 'BOM_VIEW', 'BOM_MANAGE', 'MRP_VIEW', 'MRP_RUN',
          'EQUIP_VIEW', 'EQUIP_MANAGE', 'SHOPFLOOR_VIEW'
        ];
      case UserRole.MANAGER:
        return [
          'VIEW_DASHBOARD', 'VIEW_ORDERS', 'MANAGE_ORDERS',
          'PROD_QUERY', 'FIN_VIEW_QUOTATION', 'FIN_VIEW_DASHBOARD', 'FIN_APPROVE_MARGIN',
          'WS_VIEW', 'ROUTING_VIEW', 'WO_VIEW', 'WO_SCHEDULE', 'INSP_VIEW', 'SPC_VIEW',
          'INV_VIEW', 'BOM_VIEW', 'MRP_VIEW', 'EQUIP_VIEW', 'SHOPFLOOR_VIEW'
        ];
      ...
      case UserRole.PRODUCTION:
        return [
          ...
          'WS_VIEW', 'WS_MANAGE', 'ROUTING_VIEW', 'ROUTING_MANAGE', 'WO_VIEW', 'WO_MANAGE', 'WO_SCHEDULE',
          'INSP_VIEW', 'INSP_EXECUTE', 'SPC_VIEW', 'INV_VIEW', 'BOM_VIEW', 'MRP_VIEW', 'EQUIP_VIEW', 'SHOPFLOOR_VIEW'
        ];
      case UserRole.SALES:
        return [
          'VIEW_DASHBOARD',
      ...
      case UserRole.PROCUREMENT:
        return [
          ...
          'INV_VIEW', 'INV_MANAGE', 'BOM_VIEW', 'MRP_VIEW'
        ];
      case UserRole.PRODUCT:
        return [
          'VIEW_DASHBOARD',
          'FIN_VIEW_QUOTATION', 'FIN_PRODUCT_REVIEW', 'BOM_VIEW', 'BOM_MANAGE', 'MRP_VIEW'
        ];
      default:
