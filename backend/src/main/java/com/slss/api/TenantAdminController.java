...
import com.slss.domain.*; import com.slss.repository.*; import com.slss.service.AuditService; import jakarta.transaction.Transactional; import jakarta.validation.Valid; import jakarta.validation.constraints.NotBlank; import org.springframework.security.access.prepost.PreAuthorize; import org.springframework.security.core.context.SecurityContextHolder; import org.springframework.web.bind.annotation.*; import org.springframework.web.server.ResponseStatusException; import org.springframework.http.HttpStatus; import java.util.*;
@RestController @RequestMapping("/api/v1/admin/tenants") @PreAuthorize("hasAuthority('PERM_MANAGE_SYSTEM')")
public class TenantAdminController {
 private final CustomerTenantRepository tenants; private final UserRepository users; private final UserTenantLinkRepository links; private final AssetRepository assets; private final AuditService audit;
 public TenantAdminController(CustomerTenantRepository t,UserRepository u,UserTenantLinkRepository l,AssetRepository a,AuditService au){tenants=t;users=u;links=l;assets=a;audit=au;}
 ...
 @GetMapping public List<TenantResponse> list(){return tenants.findAll().stream().map(this::dto).toList();}
