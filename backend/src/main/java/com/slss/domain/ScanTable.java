...
public class ScanTable {
 ...
 @Column(name="quality_transferred", nullable=false) private boolean qualityTransferred;
 @Column(name="quality_transferred_at") private Instant qualityTransferredAt;
 @Column(name="quality_transferred_by") private String qualityTransferredBy;
 ...
 public boolean isQualityTransferred(){return qualityTransferred;} public void setQualityTransferred(boolean v){qualityTransferred=v;} public Instant getQualityTransferredAt(){return qualityTransferredAt;} public void setQualityTransferredAt(Instant v){qualityTransferredAt=v;} public String getQualityTransferredBy(){return qualityTransferredBy;} public void setQualityTransferredBy(String v){qualityTransferredBy=v;} public CustomerTenant getTenant(){return tenant;} public void setTenant(CustomerTenant v){tenant=v;}
