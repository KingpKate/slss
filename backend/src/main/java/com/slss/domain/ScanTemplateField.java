...
public class ScanTemplateField {
 ...
 public Long getId(){return id;} public ScanTemplate getTemplate(){return template;} public void setTemplate(ScanTemplate v){template=v;} public String getFieldKey(){return fieldKey;} public void setFieldKey(String v){fieldKey=v;} public String getFieldLabel(){return fieldLabel;} public void setFieldLabel(String v){fieldLabel=v;} public String getFieldType(){return fieldType;} public void setFieldType(String v){fieldType=v;} public boolean isRequired(){return required;} public void setRequired(boolean v){required=v;} public int getSortOrder(){return sortOrder;} public void setSortOrder(int v){sortOrder=v;}
}
