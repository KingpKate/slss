...
public class ScanTableRow {
 ...
 public Long getId(){return id;} public ScanTable getScanTable(){return scanTable;} public void setScanTable(ScanTable v){scanTable=v;} public int getRowNumber(){return rowNumber;} public void setRowNumber(int v){rowNumber=v;} public String getMachineSn(){return machineSn;} public void setMachineSn(String v){machineSn=v;} public String getStatus(){return status;} public void setStatus(String v){status=v;} public void setCompletedBy(String v){completedBy=v;} public String getCompletedBy(){return completedBy;} public List<ScanTableValue> getValues(){return values;}
